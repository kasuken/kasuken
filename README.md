...
1. 🚀 Published release [v1.3.0](https://github.com/kasuken/Brainy/releases/tag/v1.3.0) in [kasuken/Brainy](https://github.com/kasuken/Brainy)
2. 🚀 Published release [v1.2.0](https://github.com/kasuken/Brainy/releases/tag/v1.2.0) in [kasuken/Brainy](https://github.com/kasuken/Brainy)
3. 🚀 Published release [v1.1.0](https://github.com/kasuken/Brainy/releases/tag/v1.1.0) in [kasuken/Brainy](https://github.com/kasuken/Brainy)
4. 🗣 Commented on [#31](https://github.com/kasuken/vscode-copilot-insights/pull/31#issuecomment-5090905649) in [kasuken/vscode-copilot-insights](https://github.com/kasuken/vscode-copilot-insights)
5. ❌ Closed PR [#36](https://github.com/kasuken/vscode-copilot-insights/pull/36) in [kasuken/vscode-copilot-insights](https://github.com/kasuken/vscode-copilot-insights)
